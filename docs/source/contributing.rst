...
AMPcombi is an open-source tool developed for parsing results from published AMP prediction tools. 
...
Whether it's contributing patches, submitting bug reports, or just asking and answering questions on the `AMPcombi repository <https://github.com/paleobiotechnology/AMPcombi>`_ – you are helping to make AMPcombi a better tool.

Adding a new tool
-----------------

We first ask you to first make an issue on `AMPcombi issues <https://github.com/paleobiotechnology/AMPcombi/issues>`_ mentioning the new tool and a reference to it.
